...
void ScoreBoard::draw(player& Player, enemy& Enemy, torch& Torch)
{
	...
	if (Player.prev == 0)
	{
		DrawString(20, 40, "è„", GetColor(255, 255, 255), true);
	}
	else if (Player.prev == 1)
	{
		DrawString(20, 40, "â∫", GetColor(255, 255, 255), true);
	}
	else if (Player.prev == 2)
	{
		DrawString(20, 40, "ç∂", GetColor(255, 255, 255), true);
	}
	else if (Player.prev == 3)
	{
		DrawString(20, 40, "âE", GetColor(255, 255, 255), true);
	}
	else if (Player.prev == 4)
	{
		DrawString(20, 40, "âEè„", GetColor(255, 255, 255), true);
	}
	else if (Player.prev == 5)
	{
		DrawString(20, 40, "âEâ∫", GetColor(255, 255, 255), true);
	}
	else if (Player.prev == 6)
	{
		DrawString(20, 40, "ç∂â∫", GetColor(255, 255, 255), true);
	}
	...
	DrawFormatString(20, 120, GetColor(255, 255, 255), "åÇîjêî = %d", Enemy.deadCount);
